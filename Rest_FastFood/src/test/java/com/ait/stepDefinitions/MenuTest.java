...
public class MenuTest {
	...
	private String navBar = "#menu";
	private String menuPage = "Menu";
	private String ceaserWrap = "Ceasar salad wrap";
	private String findFoodByClass = "card-title";
	...
	public void a_user_selects_the_menu_option_on_the_nav_bar() throws Throwable {
		driver.findElement(By.id(navBar)).click();
	}
	 	  
	
	@Then("^the menu page is displayed$")
	public void the_menu_page_is_displayed() throws Throwable {
		Thread.sleep(1000);
		String menuTitle = driver.getTitle();
		assertEquals(menuTitle, menuPage);
	}
	  
	@Then("^all available food$")
	public void all_available_food() throws Throwable {
		Thread.sleep(1000);
		String food = driver.findElement(By.className(findFoodByClass)).getText();

		assertEquals(ceaserWrap, food);
		driver.close();
	}
